...
{
    const char* pszTimestamp = "I am 4U.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517639073, 830696, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
		printf("main genesis block's hash: %s\n", genesis.GetHash().ToString().c_str());
		printf("main hashMerkleRoot: %s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x000004b1023f0925428b06ea2304bd619c8dab9e72b5c53b2f3d6e9c66b47712"));
        assert(genesis.hashMerkleRoot == uint256S("0xae179ee390f3c78480766a0c49940461a5e26c6ac399aab0d6e0474e9886422f"));
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
		printf("testnet genesis block's hash: %s\n", genesis.GetHash().ToString().c_str());
		printf("testnet hashMerkleRoot: %s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x6e7de3694b10b3f81bdafb1eedfed0f4849b9357d0438beed7e78799ec68ed97"));
        assert(genesis.hashMerkleRoot == uint256S("0xae179ee390f3c78480766a0c49940461a5e26c6ac399aab0d6e0474e9886422f"));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
		printf("regtest genesis block's hash: %s\n", genesis.GetHash().ToString().c_str());
		printf("regtest hashMerkleRoot: %s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x28345a6d3d03c01e314150b33597d9ce7284058aaeace4952fe318eae726e4b7"));
        assert(genesis.hashMerkleRoot == uint256S("0xae179ee390f3c78480766a0c49940461a5e26c6ac399aab0d6e0474e9886422f"));
